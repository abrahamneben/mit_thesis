\chapter[Beamforming Errors in MWA Antenna Tiles and their Effects on EOR Science]{Beamforming Errors in MWA Antenna Tiles and their Effects on EOR Science\footnote{This chapter was originally published as Neben, A.R. et al., \textit{Beamforming Errors in Murchison Widefield Array Phased Array Antennas and their effects on Epoch of Reionization Science}, Astrophysical Journal, 820:44, 2016. Rich Bradley gave advice about how to mitigate RF coupling in precision laboratory delay measurements, but I did all experimental work, analysis, and writing. Josh Dillon gave advice about how to assess the implications for foreground avoidance and subtraction techniques.}}
\label{chap:bferrors}
...
\caption[Gain and group delay measurements on a set of 16 LNAs are shown relative to the mean LNA.]{Gain and group delay measurements on a set of 16 LNAs are shown relative to the mean LNA, as described in Sec. \ref{sec:lnameasurements}. Error bars of $\pm15$\,ps and $\pm0.035$\,dB are the RMS of repeated measurements. At 150\,MHz, an RMS of 22ps and 0.092dB is observed. Worst cases are observed $2-3\sigma$ away from the mean.}
\label{fig:lnasplot}
\end{figure*}
