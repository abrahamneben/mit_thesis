...
THE TEXT IN THIS SECTION WAS COPIED FROM XCOR-PAPER-REV1 ON FEB 5, 2017. IT NEEDS TO BE UPDATED TO MATCH THE CURRENT VERSION OF THAT PAPER.
...
\begin{figure}[h]
\centering
\includegraphics[width=3.5in]{chap5_xcor/big_foreground_masking_study_pspecs_2_magoffset=20_56+0_274.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=3.6in]{chap5_xcor/mwa_atlas_xspec_with_2Dsimtheory_and_2sigma_errors_6bins.pdf}
...
\section{Appendix: Relation between the power spectrum of image cubes and broadband images}
...
\section{Appendix: Extending the optimal quadratic power spectrum estimator to the cross spectrum case}
