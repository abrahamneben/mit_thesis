...
\chapter[Foreground and sensitivity analysis for broad band (2D) 21\,cm--Ly$\alpha$ and 21\,cm--H$\alpha$ correlation experiments probing the Epoch of Reionization]{Foreground and sensitivity analysis for broad band (2D) 21\,cm--Ly$\alpha$ and 21\,cm--H$\alpha$ correlation experiments probing the Epoch of Reionization\footnote{Brian Stalder performed the infrared observations and the rough calibration and flat-fielding. John Tonry gave advice on infrared observations. I did all other analysis and wrote the paper.}}
\label{chap:xcor}
...
\begin{figure*}[t]
\centering
\includegraphics[width=6in]{chap5_xcor/catalog_histograms.pdf}
...
\caption[Color-color plots of ALLWISE sources showing that cutting out the brightest 10\% cleanly removes the stars.]{The ALLWISE sources are plotted in the color--color space of \citet{Wright2010} prior to any flux cuts (left panel), showing cluster of stars near (0,0). Then after cutting out the brightest 10\% of sources (fainter than 18.25\, AB mag), the stars are cleanly removed. We roughly split the remaining sources into AGNs ($W_{12}>0.6$) and starburst galaxies (SF) ($W_{12}<0.6$) \citep{mingo16}, where  $W_{12}\equiv$ [3.4\,$\mu$m] -- [4.6\,$\mu$m].}.
...
\begin{figure*}[h]
\centering
\includegraphics[width=6in]{chap5_xcor/mwa_wise_qsoagn_gal_xspec.pdf}
...
\begin{figure*}[h]
\centering
\includegraphics[width=6in]{chap5_xcor/big_foreground_masking_study_2_magoffset=20_56+0_274.pdf}
...
\begin{figure*}[h]
\centering
\includegraphics[width=6in]{chap5_xcor/big_foreground_masking_study_pspecs_2_magoffset=20_56+0_274.pdf}
...
\begin{figure*}[h]
\centering
\includegraphics[width=6in]{chap5_xcor/spectra3D_to_2D.pdf}
